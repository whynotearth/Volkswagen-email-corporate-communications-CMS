<template>
  <div class="mb-4 relative">
    <textarea
      class="input disable-scrollbars appearance-none relative bg-transparent border border-gray-600 rounded h-32 w-full px-4 py-3 focus:outline-none focus:shadow-md active:shadow-md"
      :class="[
